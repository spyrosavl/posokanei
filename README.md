...
Ένα GitHub Action τρέχει μία φορά την ημέρα (04:30 UTC), κατεβάζει ολόκληρο τον
κατάλογο (~10.100 προϊόντα με τιμές ανά αλυσίδα) και αποθηκεύει ένα στιγμιότυπο.
Η σειρά των στιγμιότυπων που μεγαλώνει σχηματίζει ένα ιστορικό αρχείο τιμών.

Μια δεύτερη εκτέλεση στις 10:30 UTC λειτουργεί ως δίχτυ ασφαλείας: σταματά
αμέσως αν το σημερινό στιγμιότυπο υπάρχει ήδη, και το κατεβάζει μόνο αν η πρωινή
εκτέλεση απέτυχε — ώστε να μην αντικαθιστά μια πετυχημένη λήψη.
